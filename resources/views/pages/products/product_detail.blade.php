...
@section('detail')
  ...
  <div class="content-container">
        <div class="left-container">
            <div class="product-image-container">
                <img class="product-image-featured" 
                  id="featured" src="{{$product_detail['feature_image_path']}}"
                  alt="Canon Image">
        ...
        <div class="right-container">
            <div>
                <h1 class="title">{{$product_detail['name']}}</h1>
        ...
        <span>
            <p>Price: <span class="price">${{number_format($product_detail['price'],0,',','.')}}</span></p>
          ...
          <div class="best_product_slider owl-carousel">
            @foreach($new_product as $item)
              <div class="single_product_item">
                <a href="{{$item['id']}}"><img src="{{$item['feature_image_path']}}" alt=""></a>
