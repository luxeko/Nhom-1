...
@section('content')
    ...
    <div class="container-fluid" id="preloader">
        @php             
        $success = Session::get('success_permission');
        if($success){
            echo "<div class='alert alert-success' id='permission_alert'>";
                echo $success;
                Session::put('success_permission', null);
            echo "</div>";
        }
    @endphp
                    ...
                    <div class="card mb-3 md-3 m-2 col-md-12">
                        <div class="row">
                            @foreach(config('permissions.module_select') as $moduleSelectItem)
                                <div class="col-2 card-body text-primary col-md-2">
                                    <label for="">
