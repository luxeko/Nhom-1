                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Thêm Setting</h3>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <div class="form-group mb-3" style="width:100%">
                                    <input type="text" class="form-control " name="name" style="width: 100%;" placeholder="Name" value="{{ old('name')}}" />
                                </div>
                                @php         
                                ...
                                @endphp
                                <div class="form-group mb-3" style="width:100%">
                                    <input type="text" class="form-control " name="link" style="width: 100%;" placeholder="Link" value="{{old('link')}}" />
                                </div>
                                @php         
                ...
                <div class="col-md-12 mt-4">
                    <div class="col-md-6 d-flex justify-content-end">
                        <div class="form-group">
                            <button class="btn btn-primary">Thêm Setting</button>
